   ...
   <!-- select -->
                 ...
                 <div class="form-group">
                  ...
                  <?php endif; ?>
                   <p>
                       <b>
                  All Licenses : <?php echo e(count($licenses)); ?> 
                  </b>
                  </p>
                   <p>
                       <b>
                  Active Licenses : <?php echo e(count($licenses_active)); ?> 
                  </b>
                  </p>
                  <?php $__currentLoopData = $active_softwares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $software): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p><b> Active <?php echo e(ucfirst($software->name )); ?> License : <?php echo e(count(\App\License::where('status',1)->where('reseller_id',$reseller->id)->where('end_at','>',date('Y-m-d'))->where('software_id',$software->id)->get())); ?> </b></p>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/license4.host/api.license4.host/application/resources/views/resellers/edit.blade.php ENDPATH**/ ?>