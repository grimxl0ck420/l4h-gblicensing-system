          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Levels</h3>
                ...
                <a href="<?php echo e(route('level.add')); ?>" class="btn btn-primary btn-block">Add</a>
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(confirm( 'Are you sure do you want to delete selected items ?' )){
                      ...
                      $form = $("<form action='<?php echo e(route('level.bulk_delete')); ?>' method='post'></form>");
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/license4.host/api.license4.host/application/resources/views/levels.blade.php ENDPATH**/ ?>