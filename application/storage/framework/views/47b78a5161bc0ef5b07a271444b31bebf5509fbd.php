      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         <li class="nav-item">
          ...
          <li class="nav-item has-treeview  <?php if(\Request::is('admin/api/*') || Request::is('admin/api') || \Request::is('admin/buyer/*') || Request::is('admin/buyer') || \Request::is('admin/message/*') || Request::is('admin/message') || Request::is('admin/settings')  ): ?> menu-open <?php endif; ?>">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview"  style="display: <?php if(\Request::is('admin/buyer/*') || Request::is('admin/buyer') || \Request::is('admin/api/*') || Request::is('admin/api') || \Request::is('admin/message/*') || Request::is('admin/message') || Request::is('admin/settings')   ): ?> block <?php else: ?> none <?php endif; ?>;" >
...
<?php /**PATH /home/license4/subdomains/api.license4.host/application/resources/views/layouts/layout.blade.php ENDPATH**/ ?>